...
bcftools query -f '%DP\n' -s SRR13107018 sample.vcf > depth_SRR18
...
samtools flagstat sample.sam > summary_sam.txt
...
awk '$1 !~ /^@/ && $2 == "99" || $2 == "83"' sample.sam > primarily_aligned.sam
...
samtools view -f 4 sample.sam > reads_unmapped.sam
